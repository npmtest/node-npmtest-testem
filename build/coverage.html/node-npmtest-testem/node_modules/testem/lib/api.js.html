...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-testem/node_modules/testem/lib/api.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-testem/node_modules/testem/lib/api.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-testem/node_modules/testem/lib/</a> &#187; api.js</div>
</div>
<div class="body">
...
Api.prototype.setup = function(mode, finalizer) {
  ...
  this.config.read(<span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >    self.app = new App(self.config, finalizer);</span>
<span class="cstat-no" title="statement not covered" >    self.app.start();</span>
  });
};
&nbsp;
...
<span class="cstat-no" title="statement not covered" >    log.stream = fs.createWriteStream(debug);</span>
  } else {
...
&nbsp;
Api.prototype.restart = <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >  this.app.triggerRun('Api: restart');</span>
};
&nbsp;
Api.prototype.startCI = <span class="fstat-no" title="function not covered" >function(options, finalizer) {</span>
<span class="cstat-no" title="statement not covered" >  this.options = options;</span>
<span class="cstat-no" title="statement not covered" >  this.setup('ci', finalizer);</span>
};
&nbsp;
Api.prototype.startServer = <span class="fstat-no" title="function not covered" >function(options) {</span>
<span class="cstat-no" title="statement not covered" >  this.options = options;</span>
<span class="cstat-no" title="statement not covered" >  var config = this.config = new Config('server', this.options);</span>
...
<span class="cstat-no" title="statement not covered" >    server.on('server-start', <span class="fstat-no" title="function not covered" >function() {</span></span>
<span class="cstat-no" title="statement not covered" >      console.log('Open ' + config.get('url') + ' in a browser to connect.');</span>
    });
  });
};
&nbsp;
